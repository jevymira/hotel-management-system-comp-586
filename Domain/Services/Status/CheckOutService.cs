...
/// <summary>
/// Concrete Strategy for a service that handles checking out a reservation
/// and freeing its assigned rooms.
/// </summary>
/// <remarks>
...
public class CheckOutService : RoomReservationService
{
    ...
    /// <summary>
    /// Checks out the reservation and unassigns its rooms; doing both together
    /// to ensure consistency between statuses.
    /// </summary>
